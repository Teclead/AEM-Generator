...
import Template from './dialogGeneratorConfig';
...
export const template = {
  ...
  datePicker: getFile(
    Template.datePicker || path.resolve(__dirname, FilePath.DatePicker)
  ),
  heading: getFile(
    Template.heading || path.resolve(__dirname, FilePath.Heading)
  ),
  fieldSet: getFile(
    Template.fieldSet || path.resolve(__dirname, FilePath.FieldSet)
  ),
  radioGroup: getFile(
    Template.radioGroup || path.resolve(__dirname, FilePath.RadioGroup)
  ),
  tracking: getFile(
  ...
  clientlibs: getFile(
    Template.clientlibs || path.resolve(__dirname, FilePath.Clientlibs)
  ),
};
